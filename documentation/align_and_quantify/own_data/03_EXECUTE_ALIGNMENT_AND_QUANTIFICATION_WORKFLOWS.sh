...
execRootDir="${root}/.tmp/analyzedData/align_and_quantify/own_data"
logRootDir="${root}/logFiles/analyzedData/align_and_quantify/own_data/anduril"
threads=2
workflowDir="${root}/.tmp/frameworksAuxiliary/anduril/align_and_quantify/own_data/workflows"
workflowPrefix="workflow."
workflowSuffix=".and"
commandFile="${root}/.tmp/frameworksAuxiliary/anduril/align_and_quantify/own_data/commands"
timeout=5    # timeout (in sec) between workflow executions; no execution if set to 0
