...
sourceDir="${root}/.tmp/analyzedData/align_and_quantify/own_data"
sourceGlobPattern=???
targetDir="${root}/analyzedData/align_and_quantify/own_data"
...
for file in "${sourceDir}/"${sourceGlobPattern}"/output/"*; do
    mv "$file" "$targetDir"
done
