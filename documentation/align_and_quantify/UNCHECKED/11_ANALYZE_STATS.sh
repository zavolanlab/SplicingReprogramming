...
dataDir="${root}/analyzedData/align_and_quantify/sra_data/merged"
outDir="${root}/analyzedData/align_and_quantify/sra_data/stats"
logDir="${root}/logFiles/analyzedData/align_and_quantify/sra_data"

# Set scripts
scriptPolyA="${scriptDir}/process_stats.polyA_removal.R"
scriptAlign="${scriptDir}/process_stats.alignments.R"
