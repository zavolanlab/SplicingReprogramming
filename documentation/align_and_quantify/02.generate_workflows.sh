...
# Generates Anduril network files for the processing of RNA-Seq data.
...
inDir="${root}/.tmp/anduril/align_and_quantify/sample_tables"
outDir="${root}/.tmp/anduril/align_and_quantify/workflows"
...
echo "Sample tables in: $inDir" >> "$logFile"
