...
sourceDir="${root}/logFiles/analyzedData/align_and_quantify/sra_data/anduril"
globPattern=???
tmpDir="${sourceDir}"
archive="${root}/logFiles/analyzedData/align_and_quantify/sra_data/anduril.tgz"
...
echo "Anduril top log directory: $sourceDir" >> "$logFile"
