...
outDir="${root}/analyzedData/summarized_data/sra"
tmpDir="${root}/.tmp/summarized_data"
...
"${scriptDir}/merge_common_field_from_multiple_tables_by_id.R" --input-directory "$in_dir" --output-directory "$out_dir" --out-file-suffix "$out_suffix" --glob "$glob" --id-suffix "$id_suffix" --has-header --annotation-table "$sampleTable" --anno-id-columns "1,2" --category-columns "3" --anno-has-header --include-ungrouped --verbose &>> "$logFile"
...
"${scriptDir}/aggregate_data_matrix_by_grouping_table.R" --input-table "$in_file" --output-table "$out_file" --grouping-table "$hsa_trx" --group-id-column 6 --has-header-input-table --verbose &>> "$logFile"
...
"${scriptDir}/aggregate_data_matrix_by_grouping_table.R" --input-table "$in_file" --output-table "$out_file" --grouping-table "$mmu_trx" --group-id-column 6 --has-header-input-table --verbose &>> "$logFile"
...
"${scriptDir}/aggregate_data_matrix_by_grouping_table.R" --input-table "$in_file" --output-table "$out_file" --grouping-table "$ptr_trx" --group-id-column 6 --has-header-input-table --verbose &>> "$logFile"
