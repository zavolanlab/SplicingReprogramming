...
workflowDir="${root}/.tmp/anduril/get_indices_and_as_events/workflows"
workflow="${workflowDir}/workflow.${fileNamePrefix}.and"
resDir="${root}/publicResources/genome_resources/${fileNamePrefix}"
genome="${resDir}/ptr.CHIMP2.1.4_84.genome.filtered.fa.gz"
transcriptome="${resDir}/ptr.CHIMP2.1.4_84.transcriptome.filtered.fa.gz"
geneAnno="${resDir}/ptr.CHIMP2.1.4_84.gene_annotations.filtered.gtf.gz"
